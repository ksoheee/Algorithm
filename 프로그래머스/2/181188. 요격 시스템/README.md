...
>
 ### 풀이 
 <p>그리디문제이며, 정렬을 필요로 한다. </p>
 <p>1. 시작점 또는 끝점으로 오름차순 해야 한다.</p>
 <p>2. 미사일의 구간을 동적으로 설정해 줘야한다. 시작 구간은 최대, 끝나는 구간은 최소로 잡아야 한다.
 즉,시작 구간은 더 큰 값을 기준으로 변경해줘야 하고, 끝 구간은 더 작은 값을 기준으로 변경해주어야 한다.</p>
